<?php global $wp_query; ?>
<article id="post-<?php the_ID(); ?>" aria-labelledby="post-<?php the_ID(); ?>-title" class="people-card people-small" itemscope <?php if($wp_query->is_post_type_archive('nu_gm_directory_item')): ?>itemprop="itemListElement" <?php endif; ?> itemtype="<?php echo nu_gm_schema(); ?>">
