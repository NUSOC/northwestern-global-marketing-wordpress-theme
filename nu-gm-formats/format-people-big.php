<?php global $wp_query; ?>
<article id="post-<?php the_ID(); ?>" aria-labelledby="post-<?php the_ID(); ?>-title" class="people-card people-big" itemscope <?php if($wp_query->is_post_type_archive('nu_gm_directory_item')): ?>itemprop="itemListElement" <?php endif; ?>itemtype="<?php echo nu_gm_schema(); ?>">
    ...
    <div class="people-image">
      <?php if( $show_image ): ?>
        <?php if( has_post_thumbnail() ): ?>
          <?php the_post_thumbnail('people-big', array('itemprop' => 'image')); ?>
        <?php else: ?>
          <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/library/images/default-people-big.gif" width="360" height="360" alt="<?php the_title(); ?>" itemprop="image" />
        <?php endif; ?>
      <?php endif; ?>
    </div>
