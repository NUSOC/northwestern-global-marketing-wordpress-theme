					...
					<div itemscope itemtype="http://schema.org/ItemList">
						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<?php if(get_theme_mod('post_list_format_setting', 'standard') == 'standard'): ?>
								...
								<article id="post-<?php the_ID(); ?>" aria-labelledby="post-<?php the_ID(); ?>-title" <?php post_class( 'cf format-standard' ); ?> itemscope itemid="#post-<?php the_ID(); ?>" itemprop="listItem" itemtype="<?php echo nu_gm_schema(); ?>" itemref="footer-publisher-info">
