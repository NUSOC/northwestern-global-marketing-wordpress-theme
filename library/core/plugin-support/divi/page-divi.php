...
<?php get_header(); ?>
				...
				<main id="main-content" tabindex="-1" class="content-full m-all t-2of3 d-5of7 cf">
					...
					<article id="post-<?php the_ID(); ?>" aria-label="<?php the_title(); ?>" <?php post_class( 'cf' ); ?> itemscope itemid="<?php the_permalink(); ?>" itemtype="<?php echo nu_gm_schema(); ?>">
						...
						<div class="article-header">
							...
							<?php else: ?>
								<h2 class="hide-label screen-reader-text" itemprop="name"><?php the_title(); ?></h2>
							<?php endif; ?>
