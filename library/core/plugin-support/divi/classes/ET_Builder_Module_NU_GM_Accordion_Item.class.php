...
class ET_Builder_Module_NU_GM_Accordion_Item extends ET_Builder_Module {
  public static $module_slug = 'et_pb_nu_gm_accordion_item';
  
  function init() {
    $this->name               = esc_html__( 'Accordion Item', 'nu_gm' );
...
new ET_Builder_Module_NU_GM_Accordion_Item;
