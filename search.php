		...
		<div class="entry-header article-header">
			...
			<div class="entry-content">
				...
				<div class="searchblox">
					<form action="https://search.northwestern.edu/" method="get" role="search" class="web-form">
						<div class="field">
							<label for="q-desktop"><strong>Search Northwestern:</strong></label>
							<input type="text" id="q-desktop" name="q" placeholder="Search web or people" value="<?php echo esc_attr(get_search_query()); ?>" />
						</div>
						<div class="field">
