<?php get_header(); ?>
				...
				<main id="main-content" tabindex="-1" class="content<?php if(!get_theme_mod('archive_display_sidebar_setting', true)): ?>-full<?php endif; ?> m-all t-2of3 d-5of7 cf">
					...
					<div itemscope itemtype="http://schema.org/ItemList">
						...
						<?php the_archive_description( '<div class="archive-description taxonomy-description" itemprop="description">', '</div>' ); ?>
						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<?php if(get_theme_mod('nu_gm_project_list_format_setting', 'feature-box') == 'standard'): ?>
								...
								<article id="post-<?php the_ID(); ?>" aria-labelledby="post-<?php the_ID(); ?>-title" <?php post_class( 'cf format-standard' ); ?> itemscope itemid="#post-<?php the_ID(); ?>" itemprop="itemListElement" itemtype="<?php echo nu_gm_schema(); ?>">
