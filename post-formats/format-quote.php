              ...
              <main id="main-content" tabindex="-1" class="content m-all t-2of3 d-5of7 cf" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/WebPageElement ">
                ...
                <article id="post-<?php the_ID(); ?>" <?php post_class('cf'); ?> itemscope itemid="<?php the_permalink(); ?>" itemtype="http://schema.org/Quotation">
                  ...
                  <header class="article-header">
                    ...
                    <p class="byline vcard">
                      <?php printf( __( 'Posted', 'nu_gm' ).' %1$s %2$s',
                         ...
                         '<span class="by">'.__( 'by', 'nu_gm' ).'</span> <span class="entry-author author" itemprop="author">' . get_the_author_link( get_the_author_meta( 'ID' ) ) . '</span>'
                      ); ?>
                  ...
                  <footer class="article-footer">
                    ...
                    <?php printf( __( 'Filed under: %1$s', 'nu_gm' ), get_the_category_list(', ') ); ?>
